...
public final class RegistrarCategoria_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("        <center>\n");
      out.write("            <h1 class=\"titulo\">Registrar Categorías productos</h1>\n");
      out.write("            <form name=\"fmrCategorias\" method=\"post\" action=\"Categoria\" onsubmit=\"return validarCategorias()\">\n");
      out.write("            <table>\n");
      out.write("                \n");
      out.write("                <tr>\n");
      out.write("                 \n");
      out.write("                    <div class=\"campos\"> Nombre Categoría </div>\n");
      out.write("                    \n");
      out.write("                    <input type=\"text\" name=\"txtNombre\" required=\"\" onkeypress=\"return validarTexto(event) \"><br><br>\n");
      ...
      out.write("                                         <button type=\"submit\" class=\"btn float-right login_btn\" > Registrar Categoría</button>\n");
      out.write("            \n");
      out.write("                                         \n");
      out.write("                                         <button type=\"submit\"  class=\"btn float-right login_btn\"> <a href=\"ConsultarCategoria.jsp\"> Ver Categorias Regitradas</a> </button>\n");
      out.write("                                        </div>\n");
      out.write("        </form>\n");
      ...
      out.write("       \n");
      out.write("       <script>\n");
      out.write("        function validarCategorias(){\n");
      out.write("            nom = document.fmrCategorias.txtNombre.value;\n");
      out.write("            if(nom.length == 0){\n");
      out.write("                alertify.alert(\"Error\",\"Ingrese Nombre de la categoría\").set('label','OK');\n");
      out.write("                return  false;\n");
      out.write("            }else{\n");
      out.write("                alertify.success(\"Categoría Ingresada con exito\");\n");
      out.write("                return true;\n");
      out.write("            }    \n");
      out.write("        }\n");
      out.write("        \n");
      out.write("        \n");
      out.write("        function validarTexto(){\n");
